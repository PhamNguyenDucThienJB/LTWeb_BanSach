...
<div class="card shadow-lg p-4 text-center" style="max-width: 400px; border-radius: 15px;">
    <div class="card-body">
        <p class="card-text fs-5 text-muted mb-4"> Đã thêm<span class="text-red">thành công</span> vào giỏ hàng
        </p>
        <div class="d-grid gap-2">
            <button class="btn btn-primary btn-lg" onclick="window.location.href='/ListOrder';">Xem đơn hàng</button>
            <button class="btn btn-danger btn-lg" onclick="window.location.href='/ListPoduct';">Thôi tôi mua tiếp !!!
            </button>
        </div>
    </div>
</div>
