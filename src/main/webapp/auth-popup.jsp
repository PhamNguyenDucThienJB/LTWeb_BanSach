...
<div class="card shadow-lg p-4 text-center" style="max-width: 400px; border-radius: 15px;">
    <div class="card-body">
        <p class="card-text fs-5 text-muted mb-4">  Bạn cần <span class="text-red">đăng nhập</span> để thực hiện thêm sản phẩm.</p>
        <div class="d-grid gap-2">
            <button class="btn btn-primary btn-lg" onclick="window.location.href='/signin.jsp';">Đăng nhập</button>
            <button class="btn btn-danger btn-lg" onclick="window.history.back();">Thoát</button>
        </div>
    </div>
</div>
<!-- Link Bootstrap JS -->
