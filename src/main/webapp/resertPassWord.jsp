...
<head>
    <meta charset="utf-8">
    <title>Books | New PassWord</title>
...
<div class="container-fluid position-relative d-flex p-0">
    ...
    <div class="container-fluid bg_signin_signup">
        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4" style="    display: contents;">
                <form id="login-form" action="/ResertPassWord`" style="border: solid;
    color: orange;" method="post" class="bg-pink rounded p-4 p-sm-5 my-4 mx-3">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" name="email" id="email" value="${auth.email}" placeholder="name@example.com" readonly>
