...
<%-- Cách 2 --%>
<%--<c:if test="${auth == null || !auth.checkRole(1)}">--%>
<%--    <%--%>
<%--        response.sendRedirect(request.getContextPath() + "/error/page-error-500.html");--%>
<%--        return;--%>
<%--    %>--%>
<%--</c:if>--%>
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="/LogoutServlet" class="dropdown-item ai-icon">
